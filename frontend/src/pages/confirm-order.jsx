        ...
        <section className="confirm-order-container">
            <div className="column1-content">
                <div className="nav-and-h1-container">
                    <Link to={`/details/${formDetails.stayId}`}>
                        <img
                            src="https://res.cloudinary.com/dpbcaizq9/image/upload/v1685990897/arrow-left-bold_veibjr.svg"
                            alt="back"
                        />
                    </Link>
                ...
                <div className="dates-container">
                    ...
                    <div className="check-in-date flex align-center">
                        <p>
                            {' '}
                            {convertDates(formDetails.info.checkin)} -{' '}
                            {convertDates(formDetails.info.checkout)}
                        </p>
                    </div>
                    <div>
                        <span> Guests </span>
                        <p>
                            {' '}
                            {formDetails.info.guests}{' '}
                            {formDetails.info.guests > 1 ? 'guests' : ' guest'}{' '}
                        </p>
                    </div>
                </div>
                ...
                <div className="cancellation-policy">
                    ...
                    <p>
                        <span>
                            ...
                            {utilService.getMonth(formDetails.info.checkin)}.{' '}
                        </span>
                        Cancel before check-in on{' '}
                        {utilService.getMonth(formDetails.info.checkout)} for a
                        partial refund.
                    </p>
                </div>
            ...
            <div className="column2-content">
                <PriceDetails
                    price={formDetails.info.price}
                    checksDates={{
                        checkIn: formDetails.info.checkin,
                        checkOut: formDetails.info.checkout,
                    }}
