    ...
    <div className="share-modal-container">
      <div className="share-modal-content">
        <div className="close-btn">
          <img onClick={handleCloseModal} class="img-close" src="/static/media/exit.1613670bda75ad67062739301b4cf941.svg" alt="exit" />
        </div>
